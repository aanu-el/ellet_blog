...
<head>
    <title> ElletBlog | Motivational </title>
...
<body>
    ...
    <div class="page-wrapper">
        ...
        <!-- Page content begins -->
        <?php
        $sql = "SELECT * FROM motivational ORDER BY id DESC";
        $query = mysqli_query($conn, $sql);
        $total = mysqli_num_rows($query);
        ?>

        <hr>
        <h1 class="daily-heading">Motivational Quotes(<?php echo $total; ?>)</h1>
        <hr>
            ...
            <div class="quote-container">
                ...
                ?>
                    ...
                    <div class="quote-block">
                        ...
                        <div class="quote-text" style="color: <?php echo $row['text_color']; ?> ;">
                            <blockquote><?php echo $row['body']; ?></blockquote>
                            <cite style="float: right;">-<?php echo $row['author']; ?></cite>
                        </div>
                    </div>
